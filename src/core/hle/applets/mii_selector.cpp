...
ResultCode MiiSelector::ReceiveParameter(Service::APT::MessageParameter const& parameter) {
...
ResultCode MiiSelector::StartImpl(Service::APT::AppletStartupParameter const& parameter) {
    started = true;
